...
export async function GET(req) {
  await db.connectDb();
  try {
    const fashionCategoryID = "66b683b6c2bd5f4688ba3e67"; // Replace with actual electronics category ID
    const total = await Product.countDocuments({ category: fashionCategoryID });
