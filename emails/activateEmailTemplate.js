export const activateEmailTemplate = ({ name, url }) => {
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%; max-width:600px;" align="center">
                          <tr>
                            <td role="modules-container" style="padding:0px 0px 0px 0px; color:#000000; text-align:left;" bgcolor="#FFFFFF" width="100%" align="left">
                              <table class="module preheader preheader-hide" role="module" data-type="preheader" border="0" cellpadding="0" cellspacing="0" width="100%" style="display: none !important; mso-hide: all; visibility: hidden; opacity: 0; color: transparent; height: 0; width: 0;">
                                <tr>
                                  <td role="module-content">
                                    <p>Confirmar dirección de email</p>
                                  </td>
                                </tr>
                              </table>
                                                ...
                                                <tbody>
                                                  <tr>
                                                    <td style="font-size:6px; line-height:10px; padding:10px 10px 0px 10px;" valign="top" align="left">
                                                      ...
                                                      <a href="https://www.saldomania.com/"><img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px; max-width:30% !important; width:30%; height:auto !important;" width="87" alt="saldomania-logo" data-proportionally-constrained="true" data-responsive="true" src="http://cdn.mcauto-images-production.sendgrid.net/52f6a5de8d102239/3da4f383-30f2-46e5-9e92-ef97b7ba8620/451x451.png"></a>
                                                    </td>
                                                  </tr>
                                                </tbody>
                                              </table>
                                                ...
                                                <tbody>
                                                  <tr>
                                                    <td style="padding:18px 0px 18px 0px; line-height:30px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content">
                                                      <div>
                                                        <h2 style="text-align: center"><span style="color: #bababa; font-size: 18px; font-family: arial, helvetica, sans-serif">Confirmar dirección de email</span></h2>
                                ...
                                <tbody>
                                  <tr>
                                    <td style="padding:18px 10px 18px 10px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content">
                                      <div>
                                        <div style="font-family: inherit; text-align: justify"><span style="font-family: arial, helvetica, sans-serif; font-size: 18px">Hola ${name}</span></div>
                                        <div style="font-family: inherit; text-align: justify"><br></div>
                                        <div style="font-family: inherit; text-align: justify"><span style="color: #000000; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: left; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space-collapse: collapse; text-wrap-mode: wrap; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline; font-family: arial, helvetica, sans-serif; font-size: 18px">¡Gracias por registrarte! Tu cuenta en Saldomanía está casi lista. Solo debes Hacer clic en el botón que aparece a continuación para confirmar tu dirección de email.</span><span style="font-family: arial, helvetica, sans-serif; font-size: 18px">&nbsp;</span></div>
                                        <div></div>
                                      </div>
                                    </td>
                                  </tr>
                              ...
                              <table class="module" role="module" data-type="spacer" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="9e43bca3-04d6-4b0d-856b-44f0166e8a11">
                                <tbody>
                                  <tr>
                              ...
                              <table border="0" cellpadding="0" cellspacing="0" class="module" data-role="module-button" data-type="button" role="module" style="table-layout:fixed;" width="100%" data-muid="e78d2768-5ea7-4a89-87a0-c40b396e5ac1">
                                <tbody>
                                  <tr>
                                    <td align="center" bgcolor="" class="outer-td" style="padding:0px 0px 0px 0px;">
                                      <table border="0" cellpadding="0" cellspacing="0" class="wrapper-mobile" style="text-align:center;">
                                        <tbody>
                                          <tr>
                                            <a href="${url}" 
   style="background-color:#3ab3ff; border:1px solid #3ab3ff; border-color:#3ab3ff; 
          border-radius:50px; border-width:1px; color:#ffffff; display:inline-block; 
          font-size:18px; font-weight:700; letter-spacing:0px; line-height:normal; 
          padding:12px 18px; text-align:center; text-decoration:none; 
          border-style:solid; font-family:arial,helvetica,sans-serif;" 
   target="_blank">
                                        ...
                                        <tr>
                                          <td style="text-align: center;">
                                            <div class="image-container" style="display: flex; justify-content: center; align-items: center; gap: 10px;">
                                              <div class="column">
                                                <a href="https://www.facebook.com/saldomaniacom/about/">
                                              ...
                                              <div class="column">
                                                <a href="https://www.instagram.com/saldomaniacom/">
                                              ...
                                              <div class="column">
                                                <a href="https://www.tiktok.com/@saldomaniacom">
                              ...
                              <table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="4399d907-f42c-4aca-b266-6499ccb3c792.2" data-mc-module-version="2019-10-22">
                                <tbody>
                                  <tr>
                                    <td style="padding:18px 10px 18px 10px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content">
                                      <div>
                                        <div style="font-family: inherit; text-align: center"><span style="font-family: arial, helvetica, sans-serif; font-size: 18px">NOTA: Este es un email generado automáticamente por Saldomanía, no lo respondas.&nbsp;</span></div>
                                      ...
                                      <table border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center;">
                                        <tr>
                                          <td style="padding: 0 10px;">
                                            <a href="https://www.saldomania.com/terms" style="color: #000000; text-decoration: none;">
                                              <span style="font-size: 14px; font-family: Arial, Helvetica, sans-serif;"><u>Términos y condiciones</u></span>
                                            </a>
                                          </td>
                                          <td style="padding: 0 10px;">
                                            <a href="https://www.saldomania.com/privacy" style="color: #000000; text-decoration: none;">
                                              <span style="font-size: 14px; font-family: Arial, Helvetica, sans-serif;"><u>Política de Privacidad</u></span>
                                            </a>
                                          </td>
                                          <td style="padding: 0 10px;">
                                            <a href="https://www.saldomania.com/clientWhatsApp" style="color: #000000; text-decoration: none;">
                                ...
                                <tbody>
                                  <tr>
                                    <td style="padding:18px 10px 10px 10px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content">
                                      <div>
                                        <div style="font-family: inherit; text-align: center"><span style="font-family: arial, helvetica, sans-serif; font-size: 14px">Empresy S.A.S - Medellín, Colombia</span></div>
                                        <div style="font-family: inherit; text-align: center"><br></div>
                                        <div></div>
                                      </div>
                                    </td>
