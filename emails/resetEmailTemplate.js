                                                ...
                                                <tbody>
                                                  <tr>
                                                    <td style="padding:18px 0px 18px 0px; line-height:30px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content">
                                                      <div>
                                                        <h2 style="text-align: center"><span style="color: #bababa; font-size: 18px; font-family: arial, helvetica, sans-serif">Recuperar contraseña</span></h2>
                                                        <div></div>
                                                      </div>
                                                    </td>
                                                  </tr>
                                        ...
                                        <tbody>
                                          <tr>
                                            <td align="center" bgcolor="#3ab3ff" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                                              <a href="${url}" style="background-color:#3ab3ff; border:1px solid #3ab3ff; border-color:#3ab3ff; border-radius:50px; border-width:1px; color:#ffffff; display:inline-block; font-size:18px; font-weight:700; letter-spacing:0px; line-height:normal; padding:12px 18px 12px 18px; text-align:center; text-decoration:none; border-style:solid; font-family:arial,helvetica,sans-serif;" target="_blank">Recuperar contraseña</a>
                                            </td>
                                          </tr>
                                        </tbody>
                                      </table>
